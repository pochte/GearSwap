...
function init_gear_sets()
	...
	back="Izdubar Mantle",waist="Isa Belt",legs="Rawhide Trousers",feet="Regal Pumps +1"}
    ...
    sets.idle = {
        head="Rawhide Mask",neck="Loricate Torque +1",ear1="Malignance Earring",ear2="Sanare Earring",
    ...
    sets.defense.PDT = {
        head="Blistering Sallet",neck="Loricate Torque +1",ear1="Malignance Earring",ear2="Genmei Earring",
